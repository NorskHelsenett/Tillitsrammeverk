...
| attestation	   | "toa"   				  | "Time of Attestation" - tidspunktet hvor attestering ble utført hos konsumenten					  |
...
* _user_selected_, som er en boolsk verdi som angir hvorvidt brukeren har gitt seg selv tilgang eller ikke
